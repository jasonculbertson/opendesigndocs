...
const $$TransitionPlan = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/departure/transition-plan");
  const { Content } = await entry.render();
  const title = entry.data.title;
  const breadcrumbs = [
    { text: "Departure", href: "/docs/leadership/departure" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/departure/transition-plan.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/departure/transition-plan.astro";
const $$url = "/docs/leadership/departure/transition-plan";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$TransitionPlan,
  file: $$file,
  url: $$url
