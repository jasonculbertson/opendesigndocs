...
const $$LongTermGoals = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/quarter-2/long-term-goals");
  const { Content } = await entry.render();
  const breadcrumbs = [
    { text: "Quarter 2", href: "/docs/leadership/quarter-2" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-2/long-term-goals.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-2/long-term-goals.astro";
const $$url = "/docs/leadership/quarter-2/long-term-goals";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$LongTermGoals,
  file: $$file,
  url: $$url
