...
const $$LeadershipBlueprint = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/day-1/leadership-blueprint");
  const { Content } = await entry.render();
  const breadcrumbs = [
    { text: "Day 1", href: "/docs/leadership/day-1" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/day-1/leadership-blueprint.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/day-1/leadership-blueprint.astro";
const $$url = "/docs/leadership/day-1/leadership-blueprint";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$LeadershipBlueprint,
  file: $$file,
  url: $$url
