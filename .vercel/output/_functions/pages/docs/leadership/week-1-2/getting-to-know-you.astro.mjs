...
const $$GettingToKnowYou = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/week-1-2/getting-to-know-you");
  const { Content } = await entry.render();
  const breadcrumbs = [
    { text: "Week 1-2", href: "/docs/leadership/week-1-2" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/week-1-2/getting-to-know-you.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/week-1-2/getting-to-know-you.astro";
const $$url = "/docs/leadership/week-1-2/getting-to-know-you";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$GettingToKnowYou,
  file: $$file,
  url: $$url
