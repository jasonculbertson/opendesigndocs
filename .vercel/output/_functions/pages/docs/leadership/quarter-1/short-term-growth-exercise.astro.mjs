...
const $$ShortTermGrowthExercise = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/quarter-1/short-term-growth-exercise");
  const { Content } = await entry.render();
  const breadcrumbs = [
    { text: "Quarter 1", href: "/docs/leadership/quarter-1" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-1/short-term-growth-exercise.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-1/short-term-growth-exercise.astro";
const $$url = "/docs/leadership/quarter-1/short-term-growth-exercise";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$ShortTermGrowthExercise,
  file: $$file,
  url: $$url
