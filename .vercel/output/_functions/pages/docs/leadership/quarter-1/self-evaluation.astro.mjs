...
const $$SelfEvaluation = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "leadership/quarter-1/self-evaluation");
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-1/self-evaluation.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/leadership/quarter-1/self-evaluation.astro";
const $$url = "/docs/leadership/quarter-1/self-evaluation";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$SelfEvaluation,
  file: $$file,
  url: $$url
