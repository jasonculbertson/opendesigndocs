...
const $$Researcher1 = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/ux-researcher/researcher-1");
  const { Content } = await entry.render();
  const title = "Researcher I";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/researcher-1.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/researcher-1.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-researcher/researcher-1";
