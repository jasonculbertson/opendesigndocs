...
const $$StaffResearcher = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/ux-researcher/staff-researcher");
  const { Content } = await entry.render();
  const title = "Staff UX Researcher";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/staff-researcher.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/staff-researcher.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-researcher/staff-researcher";
