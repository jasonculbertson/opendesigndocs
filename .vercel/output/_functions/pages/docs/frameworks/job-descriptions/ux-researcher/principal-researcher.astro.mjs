...
const $$PrincipalResearcher = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/ux-researcher/principal-researcher");
  const { Content } = await entry.render();
  const title = "Principal UX Researcher";
  const breadcrumbs = [
    { text: "Job Descriptions", href: "/docs/frameworks/job-descriptions" },
    { text: "UX Researcher", href: "/docs/frameworks/job-descriptions/ux-researcher" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/principal-researcher.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/principal-researcher.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-researcher/principal-researcher";
