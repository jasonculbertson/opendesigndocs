...
const $$SeniorResearcher = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/ux-researcher/senior-researcher");
  const { Content } = await entry.render();
  const title = "Senior UX Researcher";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/senior-researcher.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/senior-researcher.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-researcher/senior-researcher";
