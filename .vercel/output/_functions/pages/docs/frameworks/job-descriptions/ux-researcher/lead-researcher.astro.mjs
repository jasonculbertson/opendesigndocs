...
const $$LeadResearcher = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/ux-researcher/lead-researcher");
  const { Content } = await entry.render();
  const title = "Lead UX Researcher";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/lead-researcher.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-researcher/lead-researcher.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-researcher/lead-researcher";
