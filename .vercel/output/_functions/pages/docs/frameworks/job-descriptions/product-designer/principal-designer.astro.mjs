...
const $$PrincipalDesigner = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/product-designer/principal-designer");
  const { Content } = await entry.render();
  const title = "Principal Product Designer";
  const breadcrumbs = [
    { text: "Job Descriptions", href: "/docs/frameworks/job-descriptions" },
    { text: "Product Designer", href: "/docs/frameworks/job-descriptions/product-designer" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/product-designer/principal-designer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/product-designer/principal-designer.astro";
const $$url = "/docs/frameworks/job-descriptions/product-designer/principal-designer";
