...
const $$Director = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/design-ops/director");
  const { Content } = await entry.render();
  const title = "Director of Design Operations";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/director.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/director.astro";
const $$url = "/docs/frameworks/job-descriptions/design-ops/director";
