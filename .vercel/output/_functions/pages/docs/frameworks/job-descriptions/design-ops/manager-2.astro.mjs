...
const $$Manager2 = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/design-ops/manager-2");
  const { Content } = await entry.render();
  const title = "Design Operations Manager II";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/manager-2.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/manager-2.astro";
const $$url = "/docs/frameworks/job-descriptions/design-ops/manager-2";
