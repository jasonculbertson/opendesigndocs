...
const $$SeniorDirector = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/design-ops/senior-director");
  const { Content } = await entry.render();
  const title = "Senior Director of Design Operations";
  const breadcrumbs = [
    { text: "Job Descriptions", href: "/docs/frameworks/job-descriptions" },
    { text: "Design Operations", href: "/docs/frameworks/job-descriptions/design-ops" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/senior-director.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/senior-director.astro";
const $$url = "/docs/frameworks/job-descriptions/design-ops/senior-director";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$SeniorDirector,
  file: $$file,
  url: $$url
