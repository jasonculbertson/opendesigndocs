...
const $$StaffManager = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/design-ops/staff-manager");
  const { Content } = await entry.render();
  const title = "Staff Design Operations Manager";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/staff-manager.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/staff-manager.astro";
const $$url = "/docs/frameworks/job-descriptions/design-ops/staff-manager";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$StaffManager,
  file: $$file,
  url: $$url
