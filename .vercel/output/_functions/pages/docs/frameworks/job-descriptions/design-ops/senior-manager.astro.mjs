...
const $$SeniorManager = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/design-ops/senior-manager");
  const { Content } = await entry.render();
  const title = "Senior Design Operations Manager";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/senior-manager.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/design-ops/senior-manager.astro";
const $$url = "/docs/frameworks/job-descriptions/design-ops/senior-manager";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$SeniorManager,
  file: $$file,
  url: $$url
