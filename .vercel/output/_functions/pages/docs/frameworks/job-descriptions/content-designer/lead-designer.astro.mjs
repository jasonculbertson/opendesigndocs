...
const $$LeadDesigner = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/content-designer/lead-designer");
  const { Content } = await entry.render();
  const title = "Lead Content Designer";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/lead-designer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/lead-designer.astro";
const $$url = "/docs/frameworks/job-descriptions/content-designer/lead-designer";
