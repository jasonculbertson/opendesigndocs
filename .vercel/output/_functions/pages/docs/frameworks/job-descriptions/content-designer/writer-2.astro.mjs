...
const $$Writer2 = createComponent(($$result, $$props, $$slots) => {
  ...
  const breadcrumbs = [
    ...
    { text: "UX Writer", href: "/docs/frameworks/job-descriptions/ux-writer" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/writer-2.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/writer-2.astro";
const $$url = "/docs/frameworks/job-descriptions/content-designer/writer-2";
