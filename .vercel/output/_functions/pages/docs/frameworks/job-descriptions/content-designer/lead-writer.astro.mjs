...
const $$LeadWriter = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/content-designer/lead-writer");
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/lead-writer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/lead-writer.astro";
const $$url = "/docs/frameworks/job-descriptions/content-designer/lead-writer";
