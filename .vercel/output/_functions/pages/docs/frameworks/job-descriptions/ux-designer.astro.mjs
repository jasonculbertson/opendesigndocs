...
const $$UxDesigner = createComponent(async ($$result, $$props, $$slots) => {
  await getEntry("docs", "frameworks/job-descriptions/ux-designer");
  ...
  const designerLevels = [
    {
      title: "Designer I",
      description: "Skills and expectations for entry-level designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/designer-1",
      image: "\u{1F331}"
    },
    {
      title: "Designer II",
      description: "Skills and expectations for mid-level designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/designer-2",
      image: "\u26A1"
    },
    {
      title: "Sr. Designer",
      description: "Skills and expectations for senior designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/senior-designer",
      image: "\u{1F680}"
    },
    {
      title: "Lead Designer",
      description: "Skills and expectations for lead designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/lead-designer",
      image: "\u{1F465}"
    },
    {
      title: "Staff Designer",
      description: "Skills and expectations for staff designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/staff-designer",
      image: "\u2B50"
    },
    {
      title: "Principal Designer",
      description: "Skills and expectations for principal designers",
      href: "/docs/frameworks/job-descriptions/ux-designer/principal-designer",
      image: "\u{1F3AF}"
    }
  ];
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ContentGate", ContentGate, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/jasonculbertson/Documents/GitHub/opendesign/src/components/ContentGate", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<main class="py-8 px-4 sm:px-6 lg:px-8"> <article class="max-w-[680px] mx-auto"> <nav class="flex mb-2" aria-label="Breadcrumb"> <ol class="flex items-center"> ${breadcrumbs.map((crumb, index) => renderTemplate`<li class="flex items-center"> ${index > 0 && renderTemplate`<span class="mx-2 text-gray-400">/</span>`} <a${addAttribute(crumb.href, "href")} class="text-sm text-gray-600 hover:text-gray-900"> ${crumb.text} </a> </li>`)} </ol> </nav> <div class="mb-8"> <h1 class="text-[32px] font-semibold text-[#1a1f36] tracking-[-0.4px]">${title}</h1> </div> <div class="grid grid-cols-1 gap-4"> ${designerLevels.map((level) => renderTemplate`${renderComponent($$result3, "Card", $$Card, { ...level })}`)} </div> </article> </main> ` })} ` })}`;
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-designer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/ux-designer.astro";
const $$url = "/docs/frameworks/job-descriptions/ux-designer";
