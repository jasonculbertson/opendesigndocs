...
const $$StaffDesigner = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/graphic-designer/staff-designer");
  const { Content } = await entry.render();
  const title = "Staff Graphic Designer";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/staff-designer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/staff-designer.astro";
const $$url = "/docs/frameworks/job-descriptions/graphic-designer/staff-designer";
