...
const $$Designer2 = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/graphic-designer/designer-2");
  const { Content } = await entry.render();
  const title = "Graphic Designer II";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/designer-2.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/designer-2.astro";
const $$url = "/docs/frameworks/job-descriptions/graphic-designer/designer-2";
