...
const $$SeniorDesigner = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/graphic-designer/senior-designer");
  const { Content } = await entry.render();
  const title = "Senior Graphic Designer";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/senior-designer.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/graphic-designer/senior-designer.astro";
const $$url = "/docs/frameworks/job-descriptions/graphic-designer/senior-designer";
