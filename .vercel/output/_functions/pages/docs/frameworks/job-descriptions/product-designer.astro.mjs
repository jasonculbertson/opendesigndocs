  ...
  const designerLevels = [
    {
      ...
      href: "/docs/frameworks/job-descriptions/product-designer/designer-1",
      image: "\u{1F331}"
    },
    {
      title: "Designer II",
      description: "Skills and expectations for mid-level designers",
      href: "/docs/frameworks/job-descriptions/product-designer/designer-2",
      image: "\u26A1"
    },
    {
      title: "Sr. Designer",
      description: "Skills and expectations for senior designers",
      href: "/docs/frameworks/job-descriptions/product-designer/senior-designer",
      image: "\u{1F680}"
    },
    {
      title: "Lead Designer",
      description: "Skills and expectations for lead designers",
      href: "/docs/frameworks/job-descriptions/product-designer/lead-designer",
      image: "\u{1F465}"
    },
    {
      title: "Staff Designer",
      description: "Skills and expectations for staff designers",
      href: "/docs/frameworks/job-descriptions/product-designer/staff-designer",
      image: "\u2B50"
    },
    {
      title: "Principal Designer",
      description: "Skills and expectations for principal designers",
      href: "/docs/frameworks/job-descriptions/product-designer/principal-designer",
      image: "\u{1F3AF}"
    }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/product-designer/index.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/product-designer/index.astro";
const $$url = "/docs/frameworks/job-descriptions/product-designer";
