  ...
  const designerLevels = [
    {
      ...
      href: "/docs/frameworks/job-descriptions/content-designer/designer-1",
      image: "\u{1F331}"
    },
    {
      title: "Designer II",
      description: "Skills and expectations for mid-level content designers",
      href: "/docs/frameworks/job-descriptions/content-designer/designer-2",
      image: "\u26A1"
    },
    {
      title: "Sr. Designer",
      description: "Skills and expectations for senior content designers",
      href: "/docs/frameworks/job-descriptions/content-designer/senior-designer",
      image: "\u{1F680}"
    },
    {
      title: "Lead Designer",
      description: "Skills and expectations for lead content designers",
      href: "/docs/frameworks/job-descriptions/content-designer/lead-designer",
      image: "\u{1F465}"
    },
    {
      title: "Staff Designer",
      description: "Skills and expectations for staff content designers",
      href: "/docs/frameworks/job-descriptions/content-designer/staff-designer",
      image: "\u2B50"
    },
    {
      title: "Principal Designer",
      description: "Skills and expectations for principal content designers",
      href: "/docs/frameworks/job-descriptions/content-designer/principal-designer",
      image: "\u{1F3AF}"
    }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/index.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/content-designer/index.astro";
const $$url = "/docs/frameworks/job-descriptions/content-designer";
