...
const $$SeniorCopywriter = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/copywriter/senior-copywriter");
  const { Content } = await entry.render();
  const title = "Senior Copywriter";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/senior-copywriter.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/senior-copywriter.astro";
const $$url = "/docs/frameworks/job-descriptions/copywriter/senior-copywriter";
