...
const $$PrincipalCopywriter = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/copywriter/principal-copywriter");
  const { Content } = await entry.render();
  const title = "Principal Copywriter";
  const breadcrumbs = [
    { text: "Job Descriptions", href: "/docs/frameworks/job-descriptions" },
    { text: "Copywriter", href: "/docs/frameworks/job-descriptions/copywriter" }
  ];
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/principal-copywriter.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/principal-copywriter.astro";
const $$url = "/docs/frameworks/job-descriptions/copywriter/principal-copywriter";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$PrincipalCopywriter,
  file: $$file,
  url: $$url
