...
const $$LeadCopywriter = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/copywriter/lead-copywriter");
  const { Content } = await entry.render();
  const title = "Lead Copywriter";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/lead-copywriter.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/lead-copywriter.astro";
const $$url = "/docs/frameworks/job-descriptions/copywriter/lead-copywriter";
