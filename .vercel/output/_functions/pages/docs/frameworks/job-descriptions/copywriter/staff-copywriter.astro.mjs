...
const $$StaffCopywriter = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "frameworks/job-descriptions/copywriter/staff-copywriter");
  const { Content } = await entry.render();
  const title = "Staff Copywriter";
  const breadcrumbs = [
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/staff-copywriter.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/frameworks/job-descriptions/copywriter/staff-copywriter.astro";
const $$url = "/docs/frameworks/job-descriptions/copywriter/staff-copywriter";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$StaffCopywriter,
  file: $$file,
  url: $$url
