...
const $$OnePagers = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "team/product/one-pagers");
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/team/product/one-pagers.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/team/product/one-pagers.astro";
const $$url = "/docs/team/product/one-pagers";
