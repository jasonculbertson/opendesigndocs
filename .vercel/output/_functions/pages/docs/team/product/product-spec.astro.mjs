...
const $$ProductSpec = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/team/product/product-spec.astro", undefined);

const $$file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/pages/docs/team/product/product-spec.astro";
const $$url = "/docs/team/product/product-spec";
