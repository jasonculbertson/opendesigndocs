...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h1, {
      id: "self-evaluation",
      children: "Self Evaluation"
    }), "\n", createVNode("div", {
      class: "gradient-panel",
      children: createVNode("p", {
        class: "text-[17px] leading-7 text-[#1a1f36]",
        children: createVNode(_components.p, {
          children: ["Within the first quarter in a new role, I ask each team member to do a self-evaluation using the ", createVNode("a", {
            href: "/docs/leadership/month-1/level-competencies",
            children: "Level Competencies"
          }), ". We then review the self-evaluation and discuss any necessary steps to help them grow their skills."]
        })
      })
      ...
      id: "step-1-self-assessment",
      children: "Step 1: Self-Assessment"
    }), "\n", createVNode(_components.ul, {
      children: ["\n", createVNode(_components.li, {
        children: "Review each competency"
      }), "\n", createVNode(_components.li, {
        children: "Rate your current level as not meeting, meeting, or exceeding"
      }), "\n", createVNode(_components.li, {
...
const url = "src/content/docs/leadership/quarter-1/self-evaluation.mdx";
const file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/content/docs/leadership/quarter-1/self-evaluation.mdx";
...
Content.moduleId = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/content/docs/leadership/quarter-1/self-evaluation.mdx";
