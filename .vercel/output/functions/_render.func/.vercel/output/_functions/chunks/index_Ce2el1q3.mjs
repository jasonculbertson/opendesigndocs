  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h1, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "Set the long-term vision for content design across the organization"
      }), "\n", createVNode(_components.li, {
        children: "Drive content innovation that influences the industry"
      }), "\n", createVNode(_components.li, {
        children: "Lead strategic content initiatives that impact multiple products"
      }), "\n", createVNode(_components.li, {
        children: "Provide executive-level guidance on content strategy"
      }), "\n", createVNode(_components.li, {
        children: "Mentor and develop senior content leaders"
      }), "\n", createVNode(_components.li, {
        children: "Drive organizational transformation through content leadership"
      }), "\n", createVNode(_components.li, {
        children: "Represent [Company Name] in industry events and publications"
      }), "\n", createVNode(_components.li, {
        children: "Shape the future of content design in the industry"
      }), "\n"]
    }), "\n", createVNode(_components.h2, {
      id: "what-youll-need",
      ...
      children: ["\n", createVNode(_components.li, {
        children: "10+ years of experience in UX writing, content design, or related field"
      }), "\n", createVNode(_components.li, {
        children: "Recognized thought leadership in content design"
      }), "\n", createVNode(_components.li, {
        children: "Track record of driving industry-leading content innovation"
      }), "\n", createVNode(_components.li, {
        children: "Strong portfolio demonstrating exceptional strategic impact"
      }), "\n", createVNode(_components.li, {
        children: "Experience influencing executive-level decisions"
      }), "\n", createVNode(_components.li, {
        children: "History of building and scaling content organizations"
      }), "\n", createVNode(_components.li, {
        children: "Deep expertise in all aspects of content design and strategy"
      }), "\n", createVNode(_components.li, {
...
const url = "src/content/docs/frameworks/job-descriptions/content-designer/principal-designer/index.mdx";
const file = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/content/docs/frameworks/job-descriptions/content-designer/principal-designer/index.mdx";
...
Content.moduleId = "/Users/jasonculbertson/Documents/GitHub/opendesign/src/content/docs/frameworks/job-descriptions/content-designer/principal-designer/index.mdx";
